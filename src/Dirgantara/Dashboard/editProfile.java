...
public class editProfile extends JFrame{
    ...
    public editProfile(String username, String nama_akses){
        FrameConfig();
        ...
        btnUbah.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    //connect.pstat.setString(7, idUser);
        ...
        btnlogout.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                int choice = JOptionPane.showConfirmDialog(editProfile.this, "Apakah Anda yakin ingin keluar?", "Konfirmasi Keluar", JOptionPane.YES_NO_OPTION);
                if (choice == JOptionPane.YES_OPTION) {
                    JOptionPane.showMessageDialog(editProfile.this, "Terima kasih telah menggunakan aplikasi ini");
