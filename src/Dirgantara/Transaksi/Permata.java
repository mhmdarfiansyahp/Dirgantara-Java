...
public class Permata extends JFrame{
    ...
    String idPemesanan,selectedVirtualAccount, selectedPaymentMethod, tujuan, asal;
    int totalPemesanan;
    public Permata(String idPemesanan, String username, int totalPemesanan, String selectedVirtualAccount, String selectedPaymentMethod) {
        FrameConfig();
    ...
    private void updatePemesananData(String metodeBayar) {
        try {
            ...
            JOptionPane.showMessageDialog(Permata.this, "Data pemesanan berhasil diperbarui!");
        } catch (Exception ex) {
            // Tampilkan pesan error jika terjadi kesalahan
            JOptionPane.showMessageDialog(Permata.this, "Terjadi kesalahan saat memperbarui data pemesanan: " + ex.getMessage());
        }
    }
