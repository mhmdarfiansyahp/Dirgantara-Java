...
public class VirtualAccount extends JFrame{
    ...
    int totalPemesanan;
    public VirtualAccount(String idPemesanan, String username, int totalPemesanan, String selectedVirtualAccount, String selectedPaymentMethod) {
        FrameConfig();
    ...
    private void updatePemesananData(String metodeBayar) {
        try {
            ...
            JOptionPane.showMessageDialog(VirtualAccount.this, "Data pemesanan berhasil diperbarui!");
        } catch (Exception ex) {
            // Tampilkan pesan error jika terjadi kesalahan
            JOptionPane.showMessageDialog(VirtualAccount.this, "Terjadi kesalahan saat memperbarui data pemesanan: " + ex.getMessage());
        }
    }
