...
public class Indomart extends JFrame{
    ...
    int totalPemesanan;
    public Indomart(String idPemesanan, String username, int totalPemesanan, String selectedVirtualAccount, String selectedPaymentMethod) {
        FrameConfig();
        this.idPemesanan = idPemesanan;
        this.totalPemesanan = totalPemesanan;
        this.selectedVirtualAccount = selectedVirtualAccount;
        this.selectedPaymentMethod = selectedPaymentMethod;
        String randomCode = generateRandomCode(18);
    ...
    private void updatePemesananData(String metodeBayar) {
        try {
            ...
            JOptionPane.showMessageDialog(Indomart.this, "Data pemesanan berhasil diperbarui!");
        } catch (Exception ex) {
            // Tampilkan pesan error jika terjadi kesalahan
            JOptionPane.showMessageDialog(Indomart.this, "Terjadi kesalahan saat memperbarui data pemesanan: " + ex.getMessage());
        }
    }
