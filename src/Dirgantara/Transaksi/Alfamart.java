...
public class Alfamart extends JFrame{
    ...
    String idPemesanan,selectedVirtualAccount, selectedPaymentMethod, asal, tujuan;
    int totalPemesanan;
    public Alfamart(String idPemesanan, String username, int totalPemesanan, String selectedVirtualAccount, String selectedPaymentMethod) {
        FrameConfig();
    ...
    private void updatePemesananData(String metodeBayar) {
        try {
            ...
            JOptionPane.showMessageDialog(Alfamart.this, "Data pemesanan berhasil diperbarui!");
        } catch (Exception ex) {
            // Tampilkan pesan error jika terjadi kesalahan
            JOptionPane.showMessageDialog(Alfamart.this, "Terjadi kesalahan saat memperbarui data pemesanan: " + ex.getMessage());
        }
    }
    ...
    public void panggilJasper(){
        try {
            ...
            while (connection.result.next()) {
                ...
                obj[2] = connection.result.getString("jumlah");
